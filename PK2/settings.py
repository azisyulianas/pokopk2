"""
Django settings for PK2 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-wv!y!0n-u+b0kuwb4h9bdv!_s@2942t)umg#4#nz21ifpssc@-')
...
WSGI_APPLICATION = 'PK2.wsgi.application'
